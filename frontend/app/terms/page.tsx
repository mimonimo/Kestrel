    ...
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="mt-8 space-y-8">
        <Section title="1. 서비스 개요">
          <p>
            Kestrel은 CVE 취약점 정보(NVD·Exploit-DB·GitHub Advisory·MITRE)를 집계·검색하고 AI
            기반 분석을 제공하는 취약점 인텔리전스 서비스입니다. 본 서비스는{" "}
            <strong className="text-neutral-200">교육 및 방어(보안) 목적</strong>의 정보 제공을
            위한 것입니다.
          </p>
        </Section>

        <Section title="2. AI 분석 결과의 한계">
          <p>
