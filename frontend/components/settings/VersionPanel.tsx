    ...
    <div className="space-y-4">
      <div className="grid gap-3 sm:grid-cols-2">
        <Stat
          ...
          value={
            isUnknownCommit ? (
              <span className="text-amber-300">기록 없음 (수동 빌드)</span>
            ) : (
              <a
      ...
      <div className="rounded-md border border-neutral-800 bg-surface-2 p-4 text-xs">
        ...
        <div className="flex items-center gap-2">
          <code className="flex-1 select-all overflow-x-auto rounded border border-neutral-800 bg-neutral-900 px-3 py-2 font-mono text-[12px] text-emerald-300">
            {UPDATE_COMMAND}
          </code>
          <button
            type="button"
